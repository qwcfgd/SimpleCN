...
private:
    ...
    void editCustom();void editSchedules();void editSignalValue();void feedback(const QString&);
    ...
    QPushButton*m_import,*m_reload,*m_schedules,*m_once,*m_start,*m_stop,*m_back,*m_restore,*m_signalEdit;
