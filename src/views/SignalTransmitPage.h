...
private:
    ...
    void editCustom(bool existing);void editSchedules();void editSignalValue();void communication();void feedback(const QString&);
    SignalTransmitViewModel*m_vm;bool m_rendering=false;QString m_key;
    QLineEdit*m_path,*m_search,*m_raw;
    QDialog*m_configurationDialog;
    QLabel*m_configurationFeedback;
    QLabel*m_summary,*m_frameInfo,*m_status,*m_validation;
    QPushButton*m_import,*m_reload,*m_communication,*m_add,*m_edit,*m_delete,*m_schedules,*m_once,*m_start,*m_stop,*m_back,*m_restore,*m_signalEdit;
    QComboBox*m_role,*m_node,*m_schedule;
    QWidget*m_rolePanel,*m_editor;
