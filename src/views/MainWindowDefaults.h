...
struct MainWindowInitialValues {
    ...
    static constexpr const char *applicationName="Qt-GeneralController V1.4.1";
    static constexpr const char *organizationName="QtController";
    static constexpr const char *version="1.4.1";
    static constexpr const char *versionLabel="ReleaseVer: 1.4.1";
    static constexpr const char *title="Qt-GeneralController V1.4.1";
