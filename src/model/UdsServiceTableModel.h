...
public:
    ...
    QVariant headerData(int section,Qt::Orientation orientation,int role) const override {
        ...
        return QStringList{"SID","服务 / 实例","子功能 / DID / RID","参数","状态"}.value(section);
    }
    QVariant data(const QModelIndex &i,int role) const override {
        ...
        case 1:return s->name;case 2:return s->selector();case 3:return count?QString("%1 项").arg(count):QString("无需输入");
        case 4:return !s->issue.isEmpty()?QString("定义不完整"):(s->physical?QString("可配置"):QString("仅功能寻址"));default:return {};
        }
    }
