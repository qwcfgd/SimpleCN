...
def main():
    ...
    (output/"docs").mkdir()
    for name in ("User-Guide.md", "Release-1.4.2.md", "Tosun-Hardware.md", "Trace-and-Graphics.md", "Signal-Workbench-Replay.md",
    ...
    (output/"README.txt").write_text(
        ...
        encoding="utf-8-sig")
    inventory = {
        "applicationLicense": "LGPL-3.0-only", "applicationVersion": "1.4.2", "uiVersion": "Qt-GeneralController V1.4.2",
